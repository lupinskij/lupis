<?php get_header(); ?>
    ...
    <h2 class="page-intro">I'm always interested to hear about new ideas, and collaborate on interesting projects. Get in touch with me, and let's make something awesome together.</h2>
